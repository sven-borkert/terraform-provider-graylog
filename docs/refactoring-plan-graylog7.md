...
## Current Environment
- Graylog host/version: `https://graylog.example.com` running Graylog 7.0.0 (via MCP `get_system_status`).
...
- SSH available (if needed) at `root@graylog.example.com` for server-side API inspection/logs.
