...
Usage:
  python docs/fetch_api_docs.py --base-url https://graylog.example.com --user admin --password YOUR_PASSWORD
...
def main():
    ...
    parser.add_argument("--base-url", required=True, help="Graylog base URL (e.g., https://graylog.example.com)")
